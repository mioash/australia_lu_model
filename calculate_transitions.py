...
immi = (year1-1985)/5 #0-5, 1985==0, 1990==1, 1995==2, 2000==3, 2005==4, 2010==5, 2015==6
immf = immi+1 #1-6
fc_ans = sa2.filterMetadata('STE_NAME11','equals','Western Australia')
#fc_ans = fc_ans.filterMetadata('SA2_MAIN11','equals','601021005')
nmm =stt+'_'+str(year1)+'_'+str(year2)

fy = str(str(year1)[len(str(year1)) - 2: len(str(year1))])
ly = str(str(year2)[len(str(year2)) - 2: len(str(year2))])
