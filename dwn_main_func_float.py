# -*- coding: utf-8 -*-
"""
Created on Thu Jul 29 14:06:34 2021
...
def build_df (year,STT,filt_sla,suit_crop,suit_forest,suit_grass,suit_urb,two_lc,lc_prev,lc_next):
    ...
    def dil_er(image):
        kernel1 = ee.Kernel.square(radius=3)
        cclosed = image.focal_max(kernel=kernel1, iterations= 2).focal_min(kernel=kernel1, iterations= 2)
        return cclosed.updateMask(image.add(10))
